...
nodes_with_attributes_df.to_csv('/Users/zeyku390/PycharmProjects/GlycoShape/out/nodes_with_attributes.csv',sep="\t", index=False)

binding_10.to_csv('/Users/zeyku390/PycharmProjects/GlycoShape/out/binding_10.csv', sep="\t",index=False)